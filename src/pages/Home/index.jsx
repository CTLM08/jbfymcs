...
const Home = () => {
  return (
    <div>
      ...
      <section className="w-full bg-blue-500 h-96 relative">
        <div className="custom-shape-divider-top-1685012790">
          <svg
            data-name="Layer 1"
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center text-white text-5xl gap-4 ">
          <Icon
            icon="bxs:quote-left"
            className="w-48 h-48 absolute top-12 left-80 opacity-20"
          />
          <Icon
            icon="bxs:quote-right"
            className="w-48 h-48 absolute bottom-12 right-[21rem] opacity-20"
          />
          <span className="block relative -left-8 special-font">
            聪明在于勤奋，
          </span>
          <span className="block relative -right-8 special-font">
            天才在于积累。
          </span>
        </div>
      </section>
